#ifndef NEWQGROUPBOX_H
#define NEWQGROUPBOX_H

#include <QGroupBox>

class newQgroupbox : public QGroupBox
{
    Q_OBJECT

public:
    explicit newQgroupbox(QWidget *parent = 0);
    ~newQgroupbox();
protected:
...
signals:
    ...
    void SetFanMaximum(int);
    void SetselftestFanMaximumValue(int);
...
public slots:
    ...
    void setFanMaximum(int);
    void SetselftestFanMaximum(int);
